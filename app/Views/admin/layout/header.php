...
<head>
    ...
    <!-- Favicons -->
    <link
        href="<?php echo base_url() ?>admin-template/assets/img/ChatGPT_Image_Jun_3__2025__04_05_55_PM-removebg-preview.png"
        rel="icon">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="dashboard" class="logo d-flex align-items-center">
                <img src="<?php echo base_url() ?>admin-template/assets/img/ChatGPT_Image_Jun_3__2025__04_05_55_PM-removebg-preview.png"
                    alt="">
                <span class="d-none d-lg-block">Property Portal</span>
            </a>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                        ...
                        <li class="message-item">
                            <a href="#">
                                <link href="<?php echo base_url() ?>admin-template/assets/img/messages-1.jpg" alt=""
                        ...
                        <li class="message-item">
                            <a href="#">
                                <link href="<?php echo base_url() ?>admin-template/assets/img/messages-2.jpg" alt=""
                                    class="rounded-circle">
                                <div>
                                    <h4>Anna Nelson</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                        ...
                        <li class="message-item">
                            <a href="#">
                                <link href="<?php echo base_url() ?>admin-template/assets/img/messages-3.jpg" alt=""
                                    class="rounded-circle">
                                <div>
                                    <h4>David Muldon</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <img src="<?php echo base_url() ?>admin-template/assets/img/360_F_948093078_6kRWXnAWFNEaakRMX5OM9CRNNj2gdIfw.jpg"
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex justify-content-center align-items-center gap-2"
                                href="logout">
